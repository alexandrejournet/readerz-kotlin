...
class MangaAdapter(private val mList: List<MangaViewModel>) : RecyclerView.Adapter<MangaAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val mangaViewModel = mList[position]

        // sets the text to the textview from our itemHolder class
        holder.textView.text = mangaViewModel.text
